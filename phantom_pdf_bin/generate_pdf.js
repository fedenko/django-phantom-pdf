...
/***/ function(module, exports, __webpack_require__) {
	...
	var acceptLanguage, address, cookies, domain, domain_cookies, footer_contents, fs, header_contents, name, nunjucks, output, page, paperSize, system, value;
	...
	nunjucks = __webpack_require__(4);
	...
	if (paperSize.header) {
	  if (paperSize.header.contents) {
	    ...
	    paperSize.header.contents = phantom.callback(function(pageNum, numPages) {
	      return nunjucks.renderString(header_contents, {
	        page_num: pageNum,
	        num_pages: pageNum
	      });
	    });
	...
	if (paperSize.footer) {
	  if (paperSize.footer.contents) {
	    ...
	    paperSize.footer.contents = phantom.callback(function(pageNum, numPages) {
	      return nunjucks.renderString(footer_contents, {
	        page_num: pageNum,
	        num_pages: pageNum
	      });
	    });
